...
# probing
~/Documents/Workspace/kenlm/bin/lmplz -o 4 -S 30% --skip_symbols --vocab_estimate 10031 --text ../data/train.train.lower.reduce_vocab_10000.pos.txt --discount_fallback 0.5 1 1.5 | ~/Documents/Workspace/kenlm/bin/build_binary -S 20% probing /dev/stdin ../data/kenlm/4-grams.probing.kenlm

~/Documents/Workspace/kenlm/bin/lmplz -o 5 -S 30% --skip_symbols --vocab_estimate 10031 --text ../data/train.train.lower.reduce_vocab_10000.pos.txt --discount_fallback 0.5 1 1.5 | ~/Documents/Workspace/kenlm/bin/build_binary -S 20% probing /dev/stdin ../data/kenlm/5-grams.probing.kenlm